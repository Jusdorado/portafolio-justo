      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between h-14 sm:h-16 md:h-20">
          ...
          >
            ...
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-gold rounded-lg flex items-center justify-center font-serif font-bold text-moka-900 group-hover:scale-110 transition-transform duration-300 text-sm sm:text-base">
                JG
              </div>
              <span className="hidden sm:block font-serif font-bold text-base sm:text-lg text-white group-hover:text-gold-400 transition-colors duration-300">
                Justo García
              </span>
            </button>
          </motion.div>
          ...
          <motion.button
            ...
            className="lg:hidden p-2.5 rounded-lg bg-gold-400/30 backdrop-blur-sm text-white hover:bg-gold-400/40 transition-all duration-300 border border-gold-400/20 shadow-lg"
